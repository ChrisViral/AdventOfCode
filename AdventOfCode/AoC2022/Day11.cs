...
public sealed class Day11 : Solver<Day11.Monkey[]>
{
    ...
    public sealed class Monkey
    {
        ...
        {
            while (this.Items.TryDequeue(out long worry))
            {
    ...
    {
        LogAnswer(PlayRound(ROUNDS, false));

        LogAnswer(PlayRound(LONG_ROUNDS, true));
    }
