...
namespace AdventOfCode.AoC2018.Common;
...
public static class VirtualMachine
{
    ...
    {
        public override string ToString() => $"{this.Opcode.FastToString()} {this.A} {this.B} {this.C}";
    }
    ...
    public struct Registers : IEquatable<Registers>
    {
        ...
        public Registers(int a, int b, int c, int d, int e, int f) : this(a, b, c, d)
        {
            this[4] = e;
            this[5] = f;
        }
    ...
    public static void Run(ReadOnlySpan<Instruction> instructions, ref Registers registers)
    {
        // ReSharper disable once ForCanBeConvertedToForeach
        for (int i = 0; i < instructions.Length; i++)
        {
            RunInstruction(instructions[i], ref registers);
        }
    }
