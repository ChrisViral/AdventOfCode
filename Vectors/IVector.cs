...
[PublicAPI]
public interface IVector<out T> : IVector where T : unmanaged, IBinaryNumber<T>, IMinMaxValue<T>
{
    /// <summary>
...
[PublicAPI]
public interface IVector<out TComponent, TSelf> : IVector<TComponent>, INumber<TSelf>, IMinMaxValue<TSelf>
