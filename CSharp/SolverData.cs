...
public readonly struct SolverData
{
    ...
    /// <param name="fetcher">Problem input fetcher</param>
    ...
    public static async Task<SolverData> CreateData(string[] args, InputFetcher fetcher)
    {
        ...
        string input = await fetcher.EnsureInput(year, day);
