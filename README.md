# Advent of Code
My solutions to the Advent of Code challenges are found in this repository. The solutions try to keep as much as possible to the standard libraries of C#,
but a few helper libraries are used for convenience, as well as the unfortunate occasional Z3.
...
My solutions are meant to work while being as clear as possible. Speed, efficiency, and algorithmic complexity are not my first concern,
as long as it's not stupidly slow. Some answers might be naive ways to deal with certain problems,
but they'd also be the simpler way in this case, and this is what I'm going for. Sometimes I do optimise down some solutions when I have a good idea,
